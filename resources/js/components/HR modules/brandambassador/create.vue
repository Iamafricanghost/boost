<template>
  <div class="col-md-4 grid-margin stretch-card mx-auto">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Recruit brand ambassador</h4>
                    <p class="card-description">
                      Basic information
                    </p>
                    <form class="forms-sample row g-3" @submit.prevent="createAmbassador" enctype="multipart/form-data" ref="form">
                      ...
                      <button type="submit" class="btn btn-primary me-2">Create BA</button>
  ...
  <script type="text/javascript">
    ...
    export default{
      ...
      methods:{
        ...
        createAmbassador(){
              axios.post('/api/create-ambassador/',this.form)
              .then(()=> {
