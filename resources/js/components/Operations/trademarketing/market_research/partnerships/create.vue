                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample row g-3" @submit.prevent="createItem" enctype="multipart/form-data" ref="form">
                          ...
                          <div class="col-md-12">
                              <textarea type="text" class="form-control"  placeholder="Enter a description of the partnership" v-model="form.description" rows="5"></textarea>
  ...
  <script type="text/javascript">
    ...
    export default{
      ...
      methods:{
        ...
        createItem(){
              axios.post('/api/create-tmpartnership',this.form)
              .then(()=> {
