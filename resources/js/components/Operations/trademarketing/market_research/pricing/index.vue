<template>
  <div class="col-lg-8 grid-margin stretch-card" >
    <div class="card">
      <div class="card-body">
        <h4 class="card-title">Pricing stratgegies</h4>
          ...
          <table class="table table-striped">
            ...
            <tbody>
              <tr v-for="item in filtersearch" :key="item.id">
                ...
                <td >
                  <router-link :to="{ name: 'edit-tm-price' , params:{id:item.id} }" class="btn btn-primary btn-xs" >Edit</router-link>
...
deleteItem(id){
  Swal.fire({
      ...
      if (result.isConfirmed) {
              // Pass your code here 
          axios.delete('/api/deletetmprice/'+id)
          .then(()=>{
