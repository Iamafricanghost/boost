              ...
              <div class="card-body">
                ...
                <form class="forms-sample row g-3" @submit.prevent="updateItem" enctype="multipart/form-data">
                  ...
                  <div class="col-md-12">
                          ...
                          <div class="col-md-12">
                              <textarea type="text" class="form-control"  placeholder="Enter a description of the positioning. e.g. if it is a premium brand" v-model="form.position" rows="5"></textarea>
...
export default{
  ...
  created(){
      ...
      axios.get('/api/edit-tmposition/'+id)
  ...
  methods:{
    ...
    updateItem(){
          let id = this.$route.params.id
          axios.put('/api/update-tmposition/'+id,this.form)
          .then(()=> {
