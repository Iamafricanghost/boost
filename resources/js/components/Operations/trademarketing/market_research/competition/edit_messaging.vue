              ...
              <div class="card-body">
                ...
                <form class="forms-sample row g-3" @submit.prevent="updateItem" enctype="multipart/form-data">
                       ...
                       <div class="col-md-12">
                          ...
                          <div class="col-md-12">
                              <textarea type="text" class="form-control"  placeholder="Enter a description of the messaging & branding strategy." v-model="form.message" rows="5"></textarea>
                              <small class="text-danger" v-if="errors.message">{{ errors.message[0] }}</small>
                          </div>

                          <div class="col-md-12">
                              <textarea type="text" class="form-control"  placeholder="Enter a description of the tone being used" v-model="form.tone" rows="5"></textarea>
                              <small class="text-danger" v-if="errors.tone">{{ errors.tone[0] }}</small>
                          </div>
...
export default{
  ...
  created(){
      ...
      axios.get('/api/edit-tmmessage/'+id)
  ...
  methods:{
    ...
    updateItem(){
          let id = this.$route.params.id
          axios.put('/api/update-tmmessage/'+id,this.form)
          .then(()=> {
