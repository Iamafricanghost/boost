                  ...
                  <table class="table table-striped">
                    ...
                    <tbody>
                      <tr v-for="item in filtersearch" :key="item.id">
                        ...
                        <td >
                          <router-link :to="{ name: 'edit-tm-target_audience' , params:{id:item.id} }" class="btn btn-primary btn-xs" >Edit</router-link>
  ...
  methods:{
      allItems(){
        let id = localStorage.getItem('company_name')
          axios.get('/api/viewtmaudience/'+id)
      ...
      deleteItem(id){
          Swal.fire({
              ...
              if (result.isConfirmed) {
                      // Pass your code here 
                  axios.delete('/api/deletetmaudience/'+id)
                  .then(()=>{
