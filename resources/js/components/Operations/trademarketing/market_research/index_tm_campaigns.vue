<template>
          <div class="col-lg-8 grid-margin stretch-card" >
            <div class="card">
              <div class="card-body">
                <h4 class="card-title">Trade marketing campaigns</h4>
                  ...
                  <table class="table table-striped">
                    ...
                    <tbody>
                      <tr v-for="item in filtersearch" :key="item.id">
                        ...
                        <td>
                          {{ item.campaign_approx_end }}
                        </td>
                        <td >
                          <router-link :to="{ name: 'edit-tm-campaign' , params:{id:item.id} }" class="btn btn-primary btn-xs" >Edit</router-link>
                          <button type="button" class="btn btn-danger btn-xs" @click="deleteCampaign(item.id)">Del</button>
                        </td>
                      </tr>
                    </tbody>
                  </table>
