                  ...
                  <table class="table table-striped">
                    ...
                    <tbody>
                      <tr v-for="item in filtersearch" :key="item.id">
                        ...
                        <td>
                          <router-link to="/view-tm-report" class="btn btn-primary btn-xs" >Report</router-link>
                        </td>
                        <td>
                          <router-link :to="{ name: 'edit-tm-project' , params:{id:item.id} }" class="btn btn-primary btn-xs" >Edit</router-link>
                          <button type="button" class="btn btn-danger btn-xs" @click="deleteProject(item.id)">Del</button>
                        </td>
                      </tr>
                    </tbody>
                  </table>
