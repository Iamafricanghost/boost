<template>
          <div class="col-lg-6 grid-margin stretch-card mx-auto" >
            <div class="card">
              <div class="card-body">
                <h4 class="card-title">Business organs</h4>
                <p class="card-description">
                  Use navigation at the top | <span class="text-success">Use actions column for each business organ</span>
                </p>
                    ...
                    <tbody>
                      <tr v-for="item in filtersearch" :key="item.id">
                        ...
                        <td>
                          ...
                          <button type="button" class="btn btn-danger btn-sm" @click="deleteOrgan(item.id)">Del</button>
                        </td>
                      </tr>
                    </tbody>
                  </table>
  ...
  computed:{
      filtersearch(){
          return this.items.filter(item =>{
              return item.title.match(this.searchTerm)
          })
      }
  },
  methods:{
      ...
      deleteOrgan(id){
          Swal.fire({
              ...
              if (result.isConfirmed) {
                      // Pass your code here 
                  axios.delete('/api/deleteorgan/'+id)
                  .then(()=>{
