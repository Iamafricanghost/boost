          ...
          <div class="col-md-6 grid-margin stretch-card mx-auto">
            <div class="card">
              <div class="card-body">
                ...
                <form class="forms-sample row g-3" @submit.prevent="updateLead" enctype="multipart/form-data">
                  ...
                  <div class="col-md-12">
                      ...
                      <button type="submit" class="btn btn-primary me-2">Update lead</button>
...
export default{
  ...
  methods:{
    ...
    updateLead(){
          let id = this.$route.params.id
          axios.put('/api/update-lead/'+id,this.form)
          .then(()=> {
