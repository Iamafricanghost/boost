      ...
      <div class="row">
          <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item" @click="$router.go(-1)">Sectors</li>
              </ol>
           </nav>
      </div>
            ...
            <div class="card">
              <div class="card-body">
                ...
                <p class="card-description">
                  Use navigation at the top | <span class="text-success">Use actions column for each cell</span>
                </p>
