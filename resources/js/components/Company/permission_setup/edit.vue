              ...
              <div class="card-body">
                ...
                <form class="forms-sample row g-3" @submit.prevent="updatePermission" enctype="multipart/form-data">
                  ...
                  <div class="col-md-12">
                          ...
                          <div class="col-md-12">
                              <input type="text" class="form-control"  placeholder="Company Tax ID" v-model="form.company_reg">
                          ...
                          <div class="col-md-12">
                              <select class="form-select form-control" v-model="form.role">
                                ...
                                <option :value="role.role_name" v-for="role in roles">{{ role.role_name }}</option>
                              </select>
                              <small class="text-danger" v-if="errors.status">{{ errors.role[0] }}</small>
                          </div>
