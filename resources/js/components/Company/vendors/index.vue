<template>
          <div class="col-lg-6 grid-margin stretch-card mx-auto" >
            <div class="card">
              <div class="card-body">
                <h4 class="card-title">Vendors | Suppliers</h4>
                <p class="card-description">
                  Use navigation at the top | <span class="text-success">Use actions column for each business supplier</span>
                </p>
                  ...
                  <table class="table table-striped">
                    ...
                    <tbody>
                      <tr v-for="item in filtersearch" :key="item.id">
                        ...
                        <td>
                          <router-link :to="{ name: 'edit-vendor' , params:{id:item.id} }" class="btn btn-primary btn-xs" >Edit</router-link>
  ...
  computed:{
      filtersearch(){
          return this.items.filter(item =>{
              return item.service_type.match(this.searchTerm)
          })
      }
  },
  methods:{
      ...
      deleteCustomer(id){
          Swal.fire({
              ...
              if (result.isConfirmed) {
                      // Pass your code here 
                  axios.delete('/api/deletevendor/'+id)
                  .then(()=>{
