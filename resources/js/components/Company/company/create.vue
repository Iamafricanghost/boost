...
<div class="col-md-4 grid-margin stretch-card mx-auto">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample row g-3" @submit.prevent="createCompany" enctype="multipart/form-data" ref="form">
                    ...
                    <button type="submit" class="btn btn-primary me-2">Create company</button>
