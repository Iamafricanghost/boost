<template>
          <div class="col-lg-6 grid-margin stretch-card" >
            <div class="card">
              <div class="card-body">
                <h4 class="card-title">Product subcategories</h4>
                <p class="card-description">
                  Use navigation at the top | <span class="text-success">Use actions column for each project</span>
                </p>
                <input type="text" placeholder="Search subcategory name here.." class="form-control" style="width: 300px;" v-model="searchTerm"> 
                  ...
                  <table class="table table-striped">
                    ...
                    <tbody>
                      <tr v-for="item in filtersearch" :key="item.id">
                        ...
                        <td>
                          <router-link :to="{ name: 'edit-subcategory' , params:{id:item.id} }" class="btn btn-primary btn-xs" >Edit</router-link>
  ...
  computed:{
      filtersearch(){
          return this.items.filter(item =>{
              return item.product_subcategory.match(this.searchTerm)
          })
      }
  },
  methods:{
      ...
      deleteCategory(id){
          Swal.fire({
              ...
              if (result.isConfirmed) {
                  ...
                  .catch(()=> {
                      this.$router.push({name: 'product-subcategories'})
                  })
