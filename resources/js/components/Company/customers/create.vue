  ...
  <div class="col-md-4 grid-margin stretch-card mx-auto">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample row g-3" @submit.prevent="createCustomer" enctype="multipart/form-data" ref="form">
                          ...
                          <div class="col-md-6">
                            <select class="form-select form-control" aria-label="Default select example" v-model="form.account_manager">
                              <option selected>Select the account manager</option>
  ...
  <script type="text/javascript">
    ...
    export default{
      ...
      methods:{
        ...
        createCustomer(){
              axios.post('/api/create-customer/',this.form)
              .then(()=> {
