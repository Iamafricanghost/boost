<template>
  <div class="col-md-4 grid-margin stretch-card mx-auto">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Create sister company</h4>
                    <p class="card-description">
                      Basic information
                    </p>
                    <form class="forms-sample row g-3" @submit.prevent="createRelation" enctype="multipart/form-data" ref="form">
                      ...
                      <button type="submit" class="btn btn-primary me-2">Create relation</button>
  ...
  <script type="text/javascript">
    ...
    export default{
      ...
      methods:{
        ...
        createRelation(){
              axios.post('/api/create-sister/',this.form)
              .then(()=> {
