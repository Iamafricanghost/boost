    ...
    <div class="row">
      ...
      <div class="row g-3">
          <div class="col-md-4 grid-margin stretch-card mx-auto mt-5">
            <div class="card">
              <div class="card-body">
                <h4 class="card-title">Update variant information</h4>
                <p class="card-description">
                  Basic information
                </p>
                <form class="forms-sample row g-3" @submit.prevent="updateVariant" enctype="multipart/form-data">
...
export default{
  ...
  methods:{
    ...
    updateVariant(){
          let id = this.$route.params.id
          axios.put('/api/update-variant/'+id,this.form)
          .then(()=> {
